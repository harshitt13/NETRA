...
const MiniNetraLogo = () => (
  <div className="flex items-center">
    <svg width="40" height="40" viewBox="0 0 200 200" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M100 50C150 50 180 100 100 100C20 100 50 50 100 50Z" stroke="#00AEEF" strokeWidth="12"/>
      <circle cx="100" cy="100" r="30" fill="#00AEEF"/>
      <circle cx="100" cy="100" r="15" fill="#FFFFFF"/>
      <path d="M100 150C50 150 20 100 100 100C180 100 150 150 100 150Z" stroke="#00AEEF" strokeWidth="12"/>
    </svg>
